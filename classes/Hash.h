...
vector<unsigned long> convert_to_binary(const std::string input){
...
// pads the message ti  make they are a multiple of 512 bits
...
// hash function
std::string hash(const std::string result){

}
std::string hash(const vector<unsigned long> block){
    unsigned long k[64] = {
